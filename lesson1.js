...
let floatingPoint = 0.23;
let integer = 56;
let negative = - 3;
let notANumber = 4 * "attempts";
let bigNumber = 1256324587965412;
...
console.log("Q2: Stretch Goal:", bigNumber);
...
console.log("Q3: The variable I made true is: ", booleanTrue);
// The output of the above should be true.

console.log("Q3: The variable I made false is: ", booleanFalse);
...
console.log("Q4: Hello, my name is " + firstName + " " + lastName + ". I was born in the " + country + ".")

//Stretch Goal
let fourLiteral = `Hello, my name is ${firstName} ${lastName}. I was born in the ${country}.`
console.log("Q4: Stretch Goal - ", fourLiteral);
...
let addFloatingValue = floatingPoint + integer;
let addNegativeValue = negative + integer;
let floatingAnswer = `When we add ${floatingPoint} to ${integer}, we get a solution of ${addFloatingValue}.`;
let negativeAnswer = `When we add ${negative} to ${integer}, we get a solution of ${addNegativeValue}.`;

// Don't forget your console.logs!

console.log("Q5: ", floatingAnswer);
console.log("Q5: ", negativeAnswer);
...
let firstWeird = firstName[firstName.length - 1];
let lastWeird = lastName[lastName.length - 1];
let weirdInitial = firstWeird + lastWeird;

// Don't forget your console.logs!

console.log("Q6:", length);
console.log("Q6:", firstInitial);
console.log("Q6:", lastName);
console.log("Q6:", capitalize);
console.log("Q6: Stretch Goals", weirdInitial);
...
console.log("Q7: Stretch Goal:", answer7)
...
switch (randomNum) {
    case 1:
        console.log("Q9 (Stretch Goal): It is very certain.")
        break;
    case 2:
        console.log("Q9 (Stretch Goal): Perhaps.")
        break;
    case 3:
        console.log("Q9 (Stretch Goal): Absolutely Not x 2.")
};
...
let roundExNum = exampleNum.toFixed(2);
console.log("Q10:", roundExNum);
...
let stringNum = "12345";
let mathNum = 67890;
let answer11 = Number.parseInt(stringNum) * mathNum;
...
function useParams(parameter) {
    let capitalizeParams = parameter.toUpperCase();
    return capitalizeParams;
}

console.log("Q14: ", useParams("capitalize"));
...
function simpleStringLength(word3, word4) {
    return Math.max(word3.length, word4.length);
};

console.log("Q15: ", simpleStringLength(word3, word4))
